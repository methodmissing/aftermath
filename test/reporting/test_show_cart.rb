class TestReportingShowCart < Test::Unit::TestCase
  ...
  def test_product_added_to_cart
    view = Reporting::ShowCart.new({})
    view << Event(:CartCreated, :cart_id => uuid)
    view << Event(:ProductAddedToCart, :cart_id => uuid, :product_id => 1, :product_name => 'Delta', :unit_price => 10, :price => 20, :quantity => 2)
    dto = view.find(uuid)
  ...
  def test_product_removed_from_cart
    ...
    view << Event(:CartCreated, :cart_id => uuid)
    view << Event(:ProductAddedToCart, :cart_id => uuid, :product_id => 1, :product_name => 'Delta', :unit_price => 10, :price => 20, :quantity => 2)
    view << Event(:ProductRemovedFromCart, :cart_id => uuid, :product_id => 1, :unit_price => 10, :price => 20)
    dto = view.find(uuid)
    assert_equal 0, dto.total
  ...
  def test_cart_quantity_updated
    ...
    view << Event(:CartCreated, :cart_id => uuid)
    view << Event(:ProductAddedToCart, :cart_id => uuid, :product_id => 1, :product_name => 'Delta', :unit_price => 10, :price => 20, :quantity => 2)
    view << Event(:CartQuantityUpdated, :cart_id => uuid, :product_id => 1, :unit_price => 10, :price => -10, :quantity => 1)
    dto = view.find(uuid)
